...
<div class="row">
    <div   class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <h3 class="text-center">Listado de Clientes</h3>
            ...
            <a href="{{route('ventas.cliente.create')}}" class="btn btn-primary">Crear Nuevo Articulo</a>
                ...
                @foreach($personas as $per)     
                  <tr class="success">
                      ...
                      <td>{{$per->email}}</td>
                          ...
                          <td > 
                          <a href="{{route('ventas.cliente.edit',$per->idpersona)}}" class="btn btn-danger glyphicon glyphicon-alert"></a> 
